...
public protocol FileStorage: Sendable {
    ...
    ///   - data: 실제 저장될 데이터
    /// - Returns: 성공여부를 반환합니다.
    func create(at path: String, fileName name: String, data: Data) throws
    ...
    func read(at path: String, fileName name: String) throws -> Data
    ...
    /// - Returns: 성공여부를 반환합니다.
    func delete(at path: String, fileName name: String) throws
    ...
    /// - Returns: 성공여부를 반환합니다.
    func copy(at url: URL, to newPath: String, newFileName name: String) throws
    ...
    /// - Returns: 성공여부를 반환합니다.
    func copy(at path: String, fileName name: String, to newPath: String) throws
    ...
    /// - Returns: 성공여부를 반환합니다.
    func move(at path: String, fileName name: String, to newPath: String) throws
    ...
    /// - Returns: 성공여부를 반환합니다.
    func moveAll(in path: String, to newPath: String) throws
    ...
    func getURL(at path: String, fileName name: String) throws -> URL
    
    func makeDirectory(through path: String) throws
    ...
    func getFileNames(at path: String) throws -> [String]
}
